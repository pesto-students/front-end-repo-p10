...
import { superAdminLoginAPI } from "../../../services/login";
import { toast } from "react-toastify";
import axios from "../../../services/axios";
import { useNavigate } from "react-router-dom";
const SuperAdmin = ({isAuthenticated}) => {
    ...
    const handleLogin = () => {
        ...
        superAdminLoginAPI(payload).then(res=>{
    ...
    return <Box className="super-admin-login-main-container">
                <Box className="box-1">
                    <img height="100%" width="100%" src="/images/login/working-ui.jpg"/>
                </Box>
                <Box className="box-2">
                    <Typography className="title">Admin Login</Typography>
